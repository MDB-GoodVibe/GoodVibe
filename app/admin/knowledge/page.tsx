      ...
      <div className="space-y-5">
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button asChild size="sm">
              <Link href="/admin/knowledge/new">새 글 작성</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="rounded-[1.4rem] border border-[rgba(121,118,127,0.08)] bg-white px-5 py-4 shadow-[0_10px_22px_rgba(37,31,74,0.04)]">
            ...
            <p className="mt-2 text-[1.8rem] font-bold tracking-[-0.04em] text-primary">{articles.length}</p>
          </div>
          <div className="rounded-[1.4rem] border border-[rgba(121,118,127,0.08)] bg-white px-5 py-4 shadow-[0_10px_22px_rgba(37,31,74,0.04)]">
          ...
          <div className="rounded-[1.4rem] border border-[rgba(121,118,127,0.08)] bg-white px-5 py-4 shadow-[0_10px_22px_rgba(37,31,74,0.04)]">
            <p className="text-[12px] text-muted-foreground">검토 대기</p>
            <p className="mt-2 text-[1.8rem] font-bold tracking-[-0.04em] text-primary">
              ...
              >
                ...
                <div className="flex items-start">
                  <span className="rounded-full bg-[rgba(244,243,243,0.92)] px-3 py-1 text-[12px] text-muted-foreground">
                    {article.status === "draft" ? "초안" : "게시"}
                  </span>
                </div>
                <div className="text-[13px] text-muted-foreground">{formatDate(article.updatedAt)}</div>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[15px] font-semibold text-primary">새 문서 작성</p>
                <p className="text-[13px] text-muted-foreground">새 지식 글 초안을 바로 작성합니다.</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-muted-foreground">사용자가 보낸 제보를 검토합니다.</p>
              </div>
            </div>
          </Link>
        </div>

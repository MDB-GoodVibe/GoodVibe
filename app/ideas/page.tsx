...
export default async function IdeasPage({
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-[1.8rem] border border-[rgba(121,118,127,0.08)] bg-white px-5 py-5 shadow-[0_12px_24px_rgba(37,31,74,0.05)]">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <form action="/ideas" className="flex w-full flex-col gap-3 sm:flex-row lg:max-w-[520px]">
      ...
      {ideas.length > 0 ? (
        <section className="grid gap-4 md:grid-cols-2 2xl:grid-cols-3">
          {ideas.map((idea) => (
            <article
              key={idea.id}
              className="group flex min-h-[230px] flex-col rounded-[1.8rem] border border-[rgba(121,118,127,0.08)] bg-white px-5 py-5 shadow-[0_12px_24px_rgba(37,31,74,0.05)] transition hover:-translate-y-0.5"
            >
